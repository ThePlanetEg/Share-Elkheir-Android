 ...
 */
public class AccessibilityFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnCameraChangeListener, LocationManager.OnGetLocationListener, GoogleMap.OnMarkerClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_accessibility, container, false);
    ...
    private void getContributions() {
        ...
        Call<ContributionsResponse> call = apiManager
                .getAccessibility(UsersManager.getToken(getContext()),
    ...
    private void addMarkers() {
        ...
        for (Contribution contribution : contributions) {
            ...
            addMarker(contribution);
        }
    }

    private Marker addMarker(Contribution contribution) {
        LatLng accessibilityLatLng = new LatLng(contribution.latitude, contribution.longitude);
        int drawable;
        int colorTransparent;

        if (contribution.accessibility.contentEquals("easy")) {
            drawable = R.drawable.ic_circle_green;
            colorTransparent = ContextCompat.getColor(getContext(), R.color.transparent_green);

        } else if (contribution.accessibility.contentEquals("normal")) {
            drawable = R.drawable.ic_circle_yellow;
            colorTransparent = ContextCompat.getColor(getContext(), R.color.transparent_yellow);


        } else {
            drawable = R.drawable.ic_circle_dark_red;
            colorTransparent = ContextCompat.getColor(getContext(), R.color.transparent_dark_red);

        }


        Marker marker = mMap.addMarker(new MarkerOptions().
                position(accessibilityLatLng).icon(BitmapDescriptorFactory.fromResource(drawable)));
